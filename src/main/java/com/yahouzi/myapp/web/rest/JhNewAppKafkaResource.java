...
@RestController
@RequestMapping("/api/jh-new-app-kafka")
public class JhNewAppKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhNewAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhNewAppKafkaResource(KafkaProperties kafkaProperties) {
